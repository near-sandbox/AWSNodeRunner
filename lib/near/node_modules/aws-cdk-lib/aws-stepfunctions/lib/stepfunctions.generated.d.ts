 ...
 */
export interface IActivityRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IStateMachineAliasRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IStateMachineVersionRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
