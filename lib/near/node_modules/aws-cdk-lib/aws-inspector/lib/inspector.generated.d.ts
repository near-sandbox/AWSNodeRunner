 ...
 */
export interface IAssessmentTargetRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IAssessmentTemplateRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IResourceGroupRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
