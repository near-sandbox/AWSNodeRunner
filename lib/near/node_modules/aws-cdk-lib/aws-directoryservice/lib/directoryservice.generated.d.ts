 ...
 */
export interface IMicrosoftADRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ISimpleADRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
