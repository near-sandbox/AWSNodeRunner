 ...
 * @stability experimental
 */
export interface IReportGroupRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ISourceCredentialRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
