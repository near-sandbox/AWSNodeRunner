 ...
 */
export interface IConfigRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IDataflowEndpointGroupRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IMissionProfileRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
