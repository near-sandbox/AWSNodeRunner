 ...
 */
export interface IReplicationSetRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IResponsePlanRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
