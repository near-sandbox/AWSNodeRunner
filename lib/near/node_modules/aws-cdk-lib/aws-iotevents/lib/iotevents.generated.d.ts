 ...
 */
export interface IAlarmModelRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IDetectorModelRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
