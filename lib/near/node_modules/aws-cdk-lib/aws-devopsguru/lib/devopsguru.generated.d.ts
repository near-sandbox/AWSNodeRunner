 ...
 */
export interface ILogAnomalyDetectionIntegrationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface INotificationChannelRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IResourceCollectionRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
