 ...
 * @stability experimental
 */
export interface IScheduledQueryRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IInfluxDBInstanceRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
