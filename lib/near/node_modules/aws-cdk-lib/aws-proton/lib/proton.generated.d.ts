 ...
 */
export interface IEnvironmentAccountConnectionRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IEnvironmentTemplateRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IServiceTemplateRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
