 ...
 */
export interface IDevicePoolRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface INetworkProfileRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ITestGridProjectRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IVPCEConfigurationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
