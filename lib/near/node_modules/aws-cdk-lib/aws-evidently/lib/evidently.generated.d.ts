 ...
 */
export interface IExperimentRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IFeatureRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ILaunchRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
