 ...
 */
export interface IGraphRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IMemberInvitationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IOrganizationAdminRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
