 ...
 */
export interface IBrokerRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IConfigurationAssociationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
