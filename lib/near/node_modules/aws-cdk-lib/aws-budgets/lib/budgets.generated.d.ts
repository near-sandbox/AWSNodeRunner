 ...
 */
export interface IBudgetRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IBudgetsActionRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
