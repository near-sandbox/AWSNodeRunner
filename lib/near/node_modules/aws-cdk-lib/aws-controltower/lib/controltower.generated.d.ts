 ...
 */
export interface IEnabledControlRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IEnabledBaselineRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ILandingZoneRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
