 ...
 * @stability experimental
 */
export interface IApplicationVersionRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IConfigurationTemplateRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
