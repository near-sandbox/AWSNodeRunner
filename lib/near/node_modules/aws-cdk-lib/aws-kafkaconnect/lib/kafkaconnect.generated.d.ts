 ...
 * @stability experimental
 */
export interface ICustomPluginRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IWorkerConfigurationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
