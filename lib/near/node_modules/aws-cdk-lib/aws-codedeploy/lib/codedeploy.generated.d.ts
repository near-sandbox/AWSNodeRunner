 ...
 * @stability experimental
 */
export interface IDeploymentConfigRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IDeploymentGroupRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
