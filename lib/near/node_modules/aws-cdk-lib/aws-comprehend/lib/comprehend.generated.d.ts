 ...
 */
export interface IDocumentClassifierRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IFlywheelRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
