 ...
 * @stability experimental
 */
export interface IAttributeGroupRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IAttributeGroupAssociationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IResourceAssociationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
