 ...
 */
export interface ICapabilityRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IPartnershipRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
