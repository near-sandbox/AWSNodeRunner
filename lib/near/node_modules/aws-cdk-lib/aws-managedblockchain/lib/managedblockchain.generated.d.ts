 ...
 */
export interface IAccessorRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface INodeRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
