 ...
 */
export interface IACLRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IMultiRegionClusterRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
