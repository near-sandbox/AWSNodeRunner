 ...
 * @stability experimental
 */
export interface IQueueInlinePolicyRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IQueuePolicyRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
