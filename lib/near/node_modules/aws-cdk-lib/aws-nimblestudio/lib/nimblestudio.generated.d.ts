 ...
 */
export interface ILaunchProfileRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IStreamingImageRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IStudioComponentRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
