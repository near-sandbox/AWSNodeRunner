 ...
 */
export interface IProfilePermissionRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ISigningProfileRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
