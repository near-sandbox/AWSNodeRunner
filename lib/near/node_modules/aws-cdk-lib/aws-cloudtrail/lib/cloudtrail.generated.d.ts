 ...
 * @stability experimental
 */
export interface IEventDataStoreRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ITrailRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
