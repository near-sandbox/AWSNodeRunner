 ...
 * @stability experimental
 */
export interface IKeyRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IReplicaKeyRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
