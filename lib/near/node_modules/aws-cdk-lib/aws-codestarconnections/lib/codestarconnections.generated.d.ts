 ...
 * @stability experimental
 */
export interface IRepositoryLinkRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ISyncConfigurationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
