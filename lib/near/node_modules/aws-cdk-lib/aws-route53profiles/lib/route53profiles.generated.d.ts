 ...
 * @stability experimental
 */
export interface IProfileAssociationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IProfileResourceAssociationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
