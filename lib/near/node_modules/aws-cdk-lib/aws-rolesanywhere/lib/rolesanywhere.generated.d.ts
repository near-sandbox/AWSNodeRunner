 ...
 */
export interface ICRLRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ITrustAnchorRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
