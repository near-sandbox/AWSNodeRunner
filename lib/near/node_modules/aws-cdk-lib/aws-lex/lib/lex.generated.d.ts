 ...
 */
export interface IBotRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IBotAliasRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IBotVersionRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
