 ...
 */
export interface IDataIntegrationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IEventIntegrationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
