 ...
 */
export interface IRuleGroupsNamespaceRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IWorkspaceRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IScraperRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
