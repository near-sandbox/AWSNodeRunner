 ...
 * @stability experimental
 */
export interface ISamplingRuleRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ITransactionSearchConfigRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
