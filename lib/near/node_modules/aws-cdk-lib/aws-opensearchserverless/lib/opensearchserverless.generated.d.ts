 ...
 * @stability experimental
 */
export interface ICollectionRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ISecurityConfigRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ISecurityPolicyRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IVpcEndpointRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
