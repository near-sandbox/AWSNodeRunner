 ...
 */
export interface ICustomActionTypeRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IWebhookRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
