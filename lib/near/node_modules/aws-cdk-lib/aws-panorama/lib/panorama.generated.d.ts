 ...
 */
export interface IApplicationInstanceRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IPackageRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IPackageVersionRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
