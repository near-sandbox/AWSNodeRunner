 ...
 * @stability experimental
 */
export interface IDirectoryRegistrationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IServicePrincipalNameRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ITemplateGroupAccessControlEntryRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
