 ...
 */
export interface IKeyspaceRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ITypeRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
