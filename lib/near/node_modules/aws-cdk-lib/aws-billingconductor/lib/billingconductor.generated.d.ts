 ...
 * @stability experimental
 */
export interface ICustomLineItemRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IPricingPlanRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IPricingRuleRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
