 ...
 * @stability experimental
 */
export interface IOrganizationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IOrganizationalUnitRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
