 ...
 */
export interface IConfigurationManagerRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ILifecycleAutomationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
