 ...
 * @stability experimental
 */
export interface IVolumeAssociationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IWorkspaceInstanceRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
