 ...
 */
export interface IAcceleratorRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IEndpointGroupRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ICrossAccountAttachmentRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
