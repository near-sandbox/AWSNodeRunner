 ...
 * @stability experimental
 */
export interface IDatasetGroupRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ISolutionRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
