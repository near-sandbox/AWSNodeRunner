 ...
 */
export interface IConnectionAliasRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IWorkspacesPoolRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
