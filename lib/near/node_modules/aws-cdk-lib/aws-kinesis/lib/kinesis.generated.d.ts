 ...
 */
export interface IStreamRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IStreamConsumerRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
