 ...
 */
export interface IAccountAliasRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ISlackWorkspaceConfigurationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
