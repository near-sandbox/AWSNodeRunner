 ...
 * @stability experimental
 */
export interface ICertificateAuthorityRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ICertificateAuthorityActivationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
