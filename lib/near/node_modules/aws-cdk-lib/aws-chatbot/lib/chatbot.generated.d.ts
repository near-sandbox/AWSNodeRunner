 ...
 */
export interface IMicrosoftTeamsChannelConfigurationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ISlackChannelConfigurationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ICustomActionRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
