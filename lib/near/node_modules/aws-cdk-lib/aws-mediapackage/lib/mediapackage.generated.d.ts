 ...
 * @stability experimental
 */
export interface IPackagingConfigurationRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IPackagingGroupRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
