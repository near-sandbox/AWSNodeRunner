 ...
 */
export interface IAnomalyMonitorRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface IAnomalySubscriptionRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ICostCategoryRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
