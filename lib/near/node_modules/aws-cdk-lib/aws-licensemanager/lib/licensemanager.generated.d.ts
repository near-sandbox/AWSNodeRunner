 ...
 */
export interface IGrantRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ILicenseRef extends constructs.IConstruct, cdk.IEnvironmentAware {
    /**
